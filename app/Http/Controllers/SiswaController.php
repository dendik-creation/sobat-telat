...
class SiswaController extends Controller
{
    ...
    {
        $siswas = User::with('kelas')->whereNot('nis', 'admintelat')->whereNot('kelas_id', 41)->get();
        $title = 'Data Siswa';
    ...
    public function exportData()
    {
        $siswas = User::with('kelas')
            ->whereNot('nis', 'admintelat')->whereNot('kelas_id', 41)
            ->get();
    ...
    {
        $siswas = User::whereNot('nis', 'admintelat')->whereNot('kelas_id', 41)->get();
