...
@section('content_admin')
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-start align-items-center gap-2">
                                                ...
                                                <form method="POST" action="{{ url('data-siswa/' . $item->id) }}"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="d-flex flex-column flex-md-row justify-content-start align-items-center gap-3">
                        ...
                        <button class="btn btn-light-danger w-100" data-bs-toggle="modal" data-bs-target="#perbaruiKelas">
                            <i class="bi bi-arrow-repeat mb-2 me-1"></i>
                            <small>Perbarui Kelas</small>
                        </button>
                        <a class="btn btn-warning w-100" href="{{ url('/data-siswa/export') }}" target="_blank">
                            <i class="bi bi-file-earmark-arrow-down-fill mb-2 me-1"></i>
                            <small>Export Data Siswa</small>
                        </a>
                        <a class="btn btn-success w-100" href="{{ url('/data-siswa/cetak') }}" target="_blank">
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="{{ url('data-siswa/update-kelas') }}" method="POST">
                        @csrf
                        <button type="submit" class="btn btn-primary ms-1 btn-sm" data-bs-dismiss="modal">
                            <span class="">Perbarui Sekarang</span>
                        </button>
                    </form>
                </div>
            </div>
    ...
    <div class="modal fade text-left" id="importBarang" tabindex="-1" role="dialog" aria-labelledby="myModalLabel19"
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="{{ url('data-siswa/import') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="container">
                ...
                <div class="modal-body">
                    <div class="d-flex justify-content-center flex-column align-items-center">
                        <div class="d-flex justify-content-center flex-column align-items-center gap-2"
                            id="canvas_container" {{-- style="width : 323px !important; height: 204px !important" --}}>
    ...
    <script>
        ...
        function siswaGet(id) {
            return fetch(`{{ url('/data-siswa/${id}') }}`)
                .then(res => res.json())
                .then(result => result)
